...
class Wechat {
    ...
    protected static function auth($token){
        /* 获取数据 */
        /*file_put_contents('az.txt',$_GET['nonce']);
        file_put_contents('bz.txt',$_GET['timestamp']);
        file_put_contents('cz.txt',$_GET['echostr']);
        file_put_contents('dz.txt',$_GET['signature']);*/
