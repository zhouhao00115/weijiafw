...
class WxPayConfPub
{
    ...
    const APPID = 'wx956daf8b541d9260';
    //受理商ID，身份标识
    const MCHID = '1357183702';
    //商户支付密钥Key。审核通过后，在微信发送的邮件中查看
    const KEY = 'WCsfVdVgSMVbtOkAaPBfwKSRPgWiq0Y7';
    //JSAPI接口中获取openid，审核后在公众平台开启开发模式后可查看
    const APPSECRET = '060feac70298ac1353e4df0bf6f437e1';
    ...
    const NOTIFY_URL = 'http://www.ekaabb.com.cn/payment/wechat/notice.php';
